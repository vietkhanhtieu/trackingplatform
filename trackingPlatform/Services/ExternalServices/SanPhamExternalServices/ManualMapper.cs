...
<<<<<<<< HEAD:trackingPlatform/Services/SanPhamServices/ExternalServices/ManualMapper.cs
...
>>>>>>>> 4bacfd5602449a84006f53f353eb1bad2a3a2912:trackingPlatform/Services/ExternalServices/SanPhamExternalServices/ManualMapper.cs
...
namespace trackingPlatform.Services.ExternalServices.SanPhamExternalServices
{
    public class ManualMapper
    {
        ...
        public TonkhoTheohub MapTonkhoTheohubRequestForTonkhoTheohub(TonKhoTheoHubRequest tonKhoTheoHubRequest, SanPhamKinhDoanh sanPhamKinhDoanh,  Hub hub)
        {
            TonkhoTheohub tonkhoTheohub = _mapper.Map<TonkhoTheohub>(tonKhoTheoHubRequest);
            tonkhoTheohub.MaHubNavigation = hub;
            tonkhoTheohub.MaSanPhamNavigation = sanPhamKinhDoanh;
